...
class GoogleDocsConnector(BaseConnector):
    """Stub connector for Google Docs — not yet implemented."""

    CONNECTOR_TYPE = "google_docs"
    SUPPORTED_CONTENT_TYPES = [ContentType.DOCUMENT, ContentType.PAGE]
    ...
    def health_check(self) -> HealthCheck:
        return HealthCheck(
            ...
            message="Google Docs connector not yet implemented",
        )
