...
class StoryblokConnector(BaseConnector):
    """Stub connector for Storyblok — not yet implemented."""

    CONNECTOR_TYPE = "storyblok"
    ...
    def health_check(self) -> HealthCheck:
        return HealthCheck(
            ...
            message="Storyblok connector not yet implemented",
        )
    ...
    def create_content(self, item: ContentItem) -> ContentItem:
        raise NotImplementedError("Storyblok connector not yet implemented")
