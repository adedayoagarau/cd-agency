"""V2 Scrape endpoint — fetch and extract structured content from web pages."""
...
router = APIRouter(prefix="/api/v2", tags=["scrape-v2"])
...
@router.post("/scrape", response_model=ScrapeResponseV2)
async def scrape_url(body: ScrapeRequestV2) -> ScrapeResponseV2:
